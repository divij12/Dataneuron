...
mongoose.connect(dbURI, {
  ...
  findOneAndUpdate: false, // Set useFindAndModify to false to make findByIdAndUpdate() use native findOneAndUpdate()
  createIndex: true // Use to enable MongoDB driver's ensureIndex() function
